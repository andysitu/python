...
def create_question(question_text, days):
    ...
    given number of 'days' offset to not (negative for questions published
    in the past, positive for questions thta have yet to be published).
    """
...
class QuestionMethodTests(TestCase):
    ...
    def test_index_with_a_future_question_and_past_question(self):
        """
